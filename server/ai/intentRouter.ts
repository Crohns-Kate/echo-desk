...
export function describeIntent(intent: IntentType): string {
  const descriptions: Record<IntentType, string> = {
    ...
    faq_techniques: 'Question about treatment techniques',
    faq_kids: 'Question about treating children',
    faq_pain: 'Question about pain/comfort',
    faq_practitioner: 'Question about who they will see',
    faq_conditions: 'Question about specific conditions',
