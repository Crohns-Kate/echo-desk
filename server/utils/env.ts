...
export const env = {
  ...
  CLINIKO_REGION,
  CLINIKO_BASE_URL,
  CLINIKO_SHARD: process.env.CLINIKO_SHARD || 'au1',
  CLINIKO_BUSINESS_ID: process.env.CLINIKO_BUSINESS_ID!,
  CLINIKO_PRACTITIONER_ID: process.env.CLINIKO_PRACTITIONER_ID!,
  CLINIKO_PRACTITIONER_NAME: process.env.CLINIKO_PRACTITIONER_NAME || undefined,  // e.g., "Dr Michael"
  ...
  CLINIC_NAME: process.env.CLINIC_NAME || 'our clinic',
